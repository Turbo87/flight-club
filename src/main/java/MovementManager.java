...
class  MovementManager
{
	...
	*/
	...
	if (c.z > 0) {
	    if (circuit == null) return -1; else return -2; //left
	} else {
	    if (circuit == null) return 1; else return 2; //right
	}
    }
    ...
    private float circleAroundPoint() {return circleAround(circlePoint.x, circlePoint.y);}
