...
public class Clock implements Runnable
{
	...
	Clock(int t){sleepTime = t;}
	
	void addObserver(ClockObserver observer){observers.addElement(observer);}
	void removeObserver(ClockObserver observer){observers.removeElement(observer);}
	...
	long getTickCount(){return tickCount;}
	long getSeconds() { return tickCount * sleepTime/1000; }
